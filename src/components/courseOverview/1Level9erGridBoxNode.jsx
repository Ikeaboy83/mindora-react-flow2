...
// 1Level9erGridBoxNode.jsx - Grid-Node für 1. Level mit 9 Lerneinheiten
export default function OneLevelNinerGridboxNode({ data, selected }) {
  const nodeStyle = {
    position: 'relative',
    width: '60000px',
    height: '38760px', // Korrekte Höhe für 3 Reihen mit Abständen und Padding
    background: 'white',
    border: 'none',
    borderRadius: '600px',
    boxShadow: selected 
    ...
    gridTemplateRows: 'repeat(3, 1fr)', // 3 Reihen
    ...
    <>
      ...
      <div style={nodeStyle}>
        ...
        <div style={{ 
          ...
          >
            Moderne Lerneinheit 6
          </div>
        </div>

        {/* Lerneinheit 7 - Dritte Reihe */}
        <div style={{ 
          background: '#e6fefc',
          border: '4px solid #30b89b',
          borderRadius: 50,
          ...
          >
            Moderne Lerneinheit 7
          </div>
        </div>

        {/* Lerneinheit 8 - Dritte Reihe */}
        <div style={{ 
          background: '#e6fefc',
          border: '4px solid #30b89b',
          borderRadius: 50,
          ...
          >
            Moderne Lerneinheit 8
          </div>
        </div>

        {/* Lerneinheit 9 - Dritte Reihe */}
        <div style={{ 
          background: '#e6fefc',
          border: '4px solid #30b89b',
          borderRadius: 50,
